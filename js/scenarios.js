const ScenarioData = {
    'stage1': {
        ...
        briefing: "あなたは地震発生時、自宅にいる想定です。突如として巨大な揺れがあなたを襲います。自分や周囲の命を守るための、一瞬の判断を行ってください。回答は各問それぞれ選択肢の中から1つ選んでください。",
        startScene: 's1_1',
        scenes: {
            's1_1': {
                ...
                options: [
                    { 
                        ...
                        fb: { isGood: false, title: "初動対応", reason: "火の始末は大切ですが、強い揺れの最中に台所や火元へ移動すると、転倒、落下物、やけどの危険があります。まずは身を守り、揺れがおさまってから火元を確認します", ifWrong: "台所で転倒し、ガラス片で足を負傷するリスクがあります。", knowledge: "現在は自動消火装置が普及しているため、火の元よりも『シェイクアウト（身を守る）』が最優先です。" } 
                    },
                    { 
                         text: "急いで外に逃げる", next: 's1_bad2', hp:-50, 
                        fb: { isGood: false, title: "初動対応", reason: "逃げるのは揺れが収まってから行いましょう", ifWrong: "転倒し、ガラス片で足を負傷するリスクがあります。", knowledge: "危ない環境からすぐに逃げたくなる気持ちはわかりますが、まずは『シェイクアウト（身を守る）』が最優先です。" } 
                    },
                    {
            ...
            's1_4': {
                ...
                options: [
                    ...
                    { 
                        ...
                        fb: { isGood: true, title: "情報収集", reason: "停電中で充電が難しい状況では、スマートフォンの電池は重要な資源です。<br>省電力モードや機内モードを活用し、必要な情報確認や安否連絡のときだけ通信を使うようにします。<br>ラジオ、避難所の掲示、自治体からの情報など、スマートフォン以外の情報源も活用します。", knowledge: "オフラインでも使える防災アプリなどを事前に準備しておくと、通信できなくても地図や情報を確認できます。" } 
                    },
                    {
            ...
            's1_5': {
                ...
                options: [
                    { 
                        ...
                        fb: { isGood: false, title: "余震リスク", reason: "薬はとても大切ですが、暗い中で被災した自宅へ戻ることは危険です。<br>本震で損傷した建物は、余震で倒壊するおそれがあります。津波や道路損傷の危険が残っている場合もあります。<br>薬を忘れた場合は、無理に取りに戻らず、避難所スタッフ、救護班、医師、薬剤師に相談しましょう。", ifWrong: "家屋倒壊や津波の第二波に巻き込まれます。", knowledge: "『余震が続いて怖かった』という証言多数。絶対に戻ってはいけません。" } 
                    },
                    { 
                        text: "絶対に戻らない", next: 's1_end', hp:10, 
                        fb: { isGood: true, title: "余震リスク", reason: "薬はとても大切ですが、暗い中で被災した自宅へ戻ることは危険です。<br>本震で損傷した建物は、余震で倒壊するおそれがあります。津波や道路損傷の危険が残っている場合もあります。<br>薬を忘れた場合は、無理に取りに戻らず、避難所スタッフ、救護班、医師、薬剤師に相談しましょう。", knowledge: "お薬手帳、薬袋、薬の写真、家族の記憶は、災害時の服薬支援に役立ちます。普段から薬の情報を確認できるようにしておくことが大切です。<br>現地の開業医からも、薬手帳の最新ページや薬の現物の写真が、カルテを参照できない状況で役立つと指摘されています。" } 
                    }
                ]
            },
