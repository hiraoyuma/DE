            ...
            's1_1': {
                ...
                options: [
                    { 
                        ...
                        fb: { isGood: false, title: "初動対応", reason: "火を消すのは揺れが収まってから行いましょう", ifWrong: "台所で転倒し、ガラス片で足を負傷するリスクがあります。", knowledge: "現在は自動消火装置が普及しているため、火の元よりも『シェイクアウト（身を守る）』が最優先です。" } 
                    },
                    { 
                    ...
                    },
                    {
                        ...
                        fb: { isGood: true, title: "初動対応", reason: "強い揺れの最中は、火を消しに行く、外へ飛び出すといった行動で、転倒や落下物によるけがの危険が高まります。<br>まずはテーブルの下などで頭を守り、揺れがおさまってから火元や避難経路を確認します。", knowledge: "能登地震でも、家具の転倒や屋根瓦の落下による負傷が相次ぎました。" } 
                    }
                ]
            },
            ...
            's1_2': {
                ...
                options: [
                    { 
                        ...
                        fb: { isGood: true, title: "避難決断", reason: "大津波警報が出ている場合、過去の経験に頼ってその場にとどまるのは危険です。<br>避難をためらう人には、長く説得するよりも、「今すぐ高い場所へ行こう」と短く具体的に伝え、一緒に移動することが大切です。", knowledge: "実際の被災者インタビューでは、『親を怒鳴りつけてでも車に乗せたおかげで助かった』という証言があります。" } 
                    },
                    {    
                    ...
                    {            
                        ...
                        fb: { isGood: false, title: "避難決断", reason: "大津波警報が出ている場合、過去の経験に頼ってその場にとどまるのは危険です。<br>避難をためらう人には、長く説得するよりも、「今すぐ高い場所へ行こう」と短く具体的に伝え、一緒に移動することが大切です。" } 
                    }
                ]
            },
            's1_3': {
                ...
                options: [
                    ...
                    { 
                        ...
                        fb: { isGood: true, title: "避難ルート", reason: "津波避難では、安全な高い場所へ早く移動することが最優先です。<br>道路の隆起、亀裂、渋滞で車が進めない場合は、車にこだわらず、周囲の安全を確認して徒歩避難へ切り替える判断が必要です。", knowledge: "乗り捨てる際は、緊急車両の妨げにならないようキーを付けたままにするか、端に寄せるなどの配慮も必要です。" } 
                    },
                    {text: "急いで引き返す", next: 's1_4', hp:-30, 
