...
まずはテーブルの下などで頭を守り、揺れがおさまってから火元や避難経路を確認します。", knowledge: "能登地震でも、家具の転倒や屋根瓦の落下による負傷が相次ぎました。" } 
                    }
                ]
            },
            ...
            's1_2': {
                ...
                options: [
                    { 
                        ...
                        fb: { isGood: true, title: "避難決断", reason: "大津波警報が出ている場合、過去の経験に頼ってその場にとどまるのは危険です。
避難をためらう人には、長く説得するよりも、「今すぐ高い場所へ行こう」と短く具体的に伝え、一緒に移動することが大切です。", knowledge: "実際の被災者インタビューでは、『親を怒鳴りつけてでも車に乗せたおかげで助かった』という証言があります。" } 
                    },
                    {    
                    ...
                    {            
                        ...
                        fb: { isGood: false, title: "避難決断", reason: "大津波警報が出ている場合、過去の経験に頼ってその場にとどまるのは危険です。
避難をためらう人には、長く説得するよりも、「今すぐ高い場所へ行こう」と短く具体的に伝え、一緒に移動することが大切です。" } 
                    }
                ]
            },
            's1_3': {
                ...
                options: [
                    ...
                    { 
                        ...
                        fb: { isGood: true, title: "避難ルート", reason: "津波避難では、安全な高い場所へ早く移動することが最優先です。
道路の隆起、亀裂、渋滞で車が進めない場合は、車にこだわらず、周囲の安全を確認して徒歩避難へ切り替える判断が必要です。", knowledge: "乗り捨てる際は、緊急車両の妨げにならないようキーを付けたままにするか、端に寄せるなどの配慮も必要です。" } 
                    },
            ...
            's1_4': {
                ...
                options: [
                    ...
                    { 
                        ...
                        fb: { isGood: true, title: "情報収集", reason: "停電中で充電が難しい状況では、スマートフォンの電池は重要な資源です。
省電力モードや機内モードを活用し、必要な情報確認や安否連絡のときだけ通信を使うようにします。
ラジオ、避難所の掲示、自治体からの情報など、スマートフォン以外の情報源も活用します。", knowledge: "オフラインでも使える防災アプリなどを事前に準備しておくと、通信できなくても地図や情報を確認できます。" } 
                    },
                    {
            ...
            's1_5': {
                ...
                options: [
                    { 
                        ...
                        fb: { isGood: false, title: "余震リスク", reason: "薬はとても大切ですが、暗い中で被災した自宅へ戻ることは危険です。
本震で損傷した建物は、余震で倒壊するおそれがあります。津波や道路損傷の危険が残っている場合もあります。
薬を忘れた場合は、無理に取りに戻らず、避難所スタッフ、救護班、医師、薬剤師に相談しましょう。", ifWrong: "家屋倒壊や津波の第二波に巻き込まれます。", knowledge: "『余震が続いて怖かった』という証言多数。絶対に戻ってはいけません。" } 
                    },
                    { 
                        text: "絶対に戻らない", next: 's1_end', hp:10, 
                        fb: { isGood: true, title: "余震リスク", reason: "薬はとても大切ですが、暗い中で被災した自宅へ戻ることは危険です。
本震で損傷した建物は、余震で倒壊するおそれがあります。津波や道路損傷の危険が残っている場合もあります。
薬を忘れた場合は、無理に取りに戻らず、避難所スタッフ、救護班、医師、薬剤師に相談しましょう。", knowledge: "お薬手帳、薬袋、薬の写真、家族の記憶は、災害時の服薬支援に役立ちます。普段から薬の情報を確認できるようにしておくことが大切です。
現地の開業医からも、薬手帳の最新ページや薬の現物の写真が、カルテを参照できない状況で役立つと指摘されています。" } 
                    }
                ]
            },
